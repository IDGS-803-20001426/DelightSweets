...
class Galleta(db.Model):
    ...
    inventarios = db.relationship('InventarioProductoTerminado', backref='galleta', foreign_keys="[InventarioProductoTerminado.id_galleta]")
    recetas = db.relationship('Receta', backref='galleta')  # Elimina este backref
